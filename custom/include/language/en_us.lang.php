...
//       it is the key for the default case_relationship_type_dom value
    ...
    'call_status_disbursement_dom' => array (
        'Number of customers are busy' => 'Number of customers are busy',
        'Relatives ask to call back later' => 'Relatives ask to call back later',
        'Customer does not have any card' => 'Customer does not have any card', 
        'Customers are not suitable for information' => 'Customers are not suitable for information',
        'Customer denied fraud suspicion' => 'Customer denied fraud suspicion',
        'Customers are thinking again - call back later' => 'Customers are thinking again - call back later',
        'Customers who want to borrow do not have a card' => 'Customers who want to borrow do not have a card',
        'Customers are interested but haven\'t picked up the phone yet' => 'Customers are interested but haven\'t picked up the phone yet',
        'Customers are waiting for the card to arrive' => 'Customers are waiting for the card to arrive',
        'Customer is accepted and has been transferred' => 'Customer is accepted and has been transferred',
        'Customer agrees but has not disbursed' => 'Customer agrees but has not disbursed',
        'Customers refuse high interest rates' => 'Customers refuse high interest rates'
    ),
    ...
    'call_status_description_lead_dom' => array (
        ...
        '04_NCT_Relative_call_back' => 'Relative call back',
        '05_NCT_Relative_call_new' => 'Relative call new',
        '06_NCT_Invalid_number' => 'Invalid number',
        '01_COT_Not_eligible_No_Card' => 'Not eligible – No Card',
        '02_COT_Not_eligible_Wrong_Info' => 'Not eligible - Wrong Info',
        '03_COT_Not_interested_Complain' => 'Not interested – Complain',
        '04_COT_Client_busy' => 'Client busy',
        '01_INT_no_money_in_card' => 'Client is rejected/ no money in card',
        '02_INT_Consider_Call_back' => 'Consider - Call back',
        '03_INT_Client_need_a_card' => 'Client need a card',
        '04_INT_Client_interest_but_no_pick_up' => 'Client interest but no pick up',
        '05_INT_Client_interest_but_no_pick_up' => 'Client waiting card', 
        '01_AGD_Approved_and_paid_money' => 'Approved and paid money',
        '02_AGD_Schedules_Application_with_disbursement' => 'Schedules Application with disbursement',
        '03_AGD_Agreed_but_still_not_contact' => 'Agreed but still not contact',
        '01_RFS_Refused_negative' => 'Refused – negative',
        '02_RFS_Refused_High_Rate' => 'Refused - High Rate',
        '03_RFS_Refused_Loan_Amount' => 'Refused - Loan Amount',
        '04_RFS_Refused_No_need' => 'Refused - No need',
    ),
...
$app_strings = array(
    ...
    'LBL_AMIN_SAVED_FILTER_SHORTCUT' => 'Admin\'s Filters',
