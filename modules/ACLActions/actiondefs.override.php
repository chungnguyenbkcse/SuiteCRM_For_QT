 ...
 */
 ...
 if (!defined('ACL_ALLOW_NONE')) {
     ...
     define('ACL_ALLOW_GROUP_AND_GROUP_CHILD', 96);
     /* END - SECURITY GROUPS */
 ...
 $GLOBALS['ACLActionAccessLevels'] = array(
    ...
    ACL_ALLOW_GROUP_AND_GROUP_CHILD=> array('color'=>'#0000FF', 'label'=>'LBL_GROUP_AND_GROUP_CHILD', 'text_color'=>'white'),
    /* BEGIN - SECURITY GROUPS */
...
$GLOBALS['ACLActions'] = array(
    'module'=>array('actions'=>
                        ...
                        'list'=>
                                array(
                                    'aclaccess'=>array(ACL_ALLOW_ALL,ACL_ALLOW_GROUP,ACL_ALLOW_GROUP_AND_GROUP_CHILD,ACL_ALLOW_OWNER,ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE),
                        ...
                        'divide'=>
                            array(
                                    'aclaccess'=>array(ACL_ALLOW_ALL,ACL_ALLOW_GROUP_AND_GROUP_CHILD,ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE, ACL_ALLOW_OWNER),
